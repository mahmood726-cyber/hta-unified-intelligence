        # Hta Unified Intelligence: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/hta-unified-intelligence.git

        ## Objective

        HTA Unified Intelligence System integrates evidence synthesis, decision modelling, and health economic analysis into a single reproducible pipeline for HTA submissions.
        ...
        - Code: https://github.com/mahmood726-cyber/hta-unified-intelligence.git
